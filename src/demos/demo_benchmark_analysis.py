...
if __name__ == "__main__":
    ...
    max_samples = 10
    root = "/home/yahya/work/datasets/PedestrianDetectionSensitivityDatasets/PennFudanPed"
    coco_json_path = "/home/yahya/work/datasets/PedestrianDetectionSensitivityDatasets/PennFudanPed/coco.json"

    # Parameters MoTSynth
    dataset_name = "motsynth_small"
    root = "/home/yahya/work/datasets/PedestrianDetectionSensitivityDatasets/motsynth_small"
    max_samples = 1
    ...
    root = "/home/yahya/work/datasets/PedestrianDetectionSensitivityDatasets/ecp_small"
    max_samples = 2
    model_names = ["faster-rcnn_cityscapes", "mask-rcnn_coco"]
    coco_json_path = None
    ...
    # root = "/home/yahya/work/datasets/twincity-Unreal/v5"
    root = "/home/yahya/work/datasets/PedestrianDetectionSensitivityDatasets/Twincity-Unreal-v9"
    max_samples = 3
    model_names = ["faster-rcnn_cityscapes", "mask-rcnn_coco"]
    coco_json_path = None
    ...
    # root = "/home/yahya/work/datasets/twincity-Unreal/v5"
    root = f"/home/yahya/work/datasets/PedestrianDetectionSensitivityDatasets/{dataset_name}"
    max_samples = 1
    model_names = ["faster-rcnn_cityscapes"] #, "mask-rcnn_coco"]
    coco_json_path = None
    force_recompute = False
