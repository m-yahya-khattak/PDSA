...
class FasterRCNCityscapesDetector(Detector):
    def __init__(self, name, device="cuda", nms=False, task="pedestrian_detection"):
        ...
        # todo handle paths
        self.checkpoint_path = "/home/yahya/work/checkpoints/detection/faster_rcnn_r50_fpn_1x_cityscapes_20200502-829424c0.pth"
        self.config_path = "/home/yahya/work/code/pedestrian-detection-sensitivity-analysis/configs/models/faster_rcnn/faster-rcnn_cityscapes.py"
