...
if __name__ == "__main__":
    ...
    # Full dataset path
    fulldataset_folder_path = "/media/yahya/Projects/datasets/EuroCityPerson/ECP"
    newdataset_folder_path = "/home/yahya/work/datasets/PedestrianDetectionSensitivityDatasets/ecp_small"
