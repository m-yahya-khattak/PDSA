...
class TestOutput(unittest.TestCase):
    ...
    def test_load_twincity_dataset(self):
        ...
        root = "/home/yahya/work/datasets/PedestrianDetectionSensitivityDatasets/twincity-Unreal/v5"
        max_samples = 1
        self.perform_test_load_dataset(dataset_name, root, max_samples)

    def test_load_ecp_dataset(self):
        dataset_name = "ecp_small"
        DATASET_ROOT = "/home/yahya/work/datasets/PedestrianDetectionSensitivityDatasets"
    ...
    def test_load_coco_datasets(self):
        ...
        dataset_name = "Fudan"
        max_samples = 200
        root = "/home/yahya/work/datasets/PennFudanPed"
        coco_json_path = "/home/yahya/work/datasets/PedestrianDetectionSensitivityDatasets/PennFudanPed/coco.json"
        cocoprocess = COCOProcessing(root, dataset_name, max_samples).get_dataset()
